...
RETRIEVAL_LIMIT = _env_int("RETRIEVAL_LIMIT", 12)
MAX_CONTEXTS = _env_int("MAX_CONTEXTS", 5)
MODEL_CONTEXT_TOKENS = _env_int("MODEL_CONTEXT_TOKENS", 16_384)
DEFAULT_MAX_OUTPUT_TOKENS = _env_int("DEFAULT_MAX_OUTPUT_TOKENS", 900)
MAX_OUTPUT_TOKENS = _env_int("MAX_OUTPUT_TOKENS", 1_200)
